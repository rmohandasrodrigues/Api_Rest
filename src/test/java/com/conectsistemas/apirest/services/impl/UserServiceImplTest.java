...
class UserServiceImplTest {
    ...
    void whenUpdateThenReturnSuccess() {
        ...
        User response = userService.upadate(userDTO);
    ...
    void deleteWithSuccess() {
        ...
        //Chamada não faça nada quando meu metodo userRepository.deleteById() for chamado
        // passando qualuqer valor inteiro.
        doNothing().when(userRepository).deleteById(anyInt());
        userService.delete(ID);

        //Verifica quantas vezes meu repository foi chamado no metodo deleteById.
        verify(userRepository,times(1)).deleteById(anyInt());
    }

    @Test
    void deleteWithObjectNotFoundExcepion() {
